...
export const GradientCard = ({ 
  ...
  const CardContainer = link ? Link : motion.div;

  return (
    <div className="relative overflow-hidden rounded-[32px] w-full h-full">
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0) 40%, rgba(255,255,255,0) 80%, rgba(255,255,255,0.08) 100%)",
        ...
        <motion.div
          ...
          style={{
            background: `
              radial-gradient(ellipse at bottom right, rgba(192, 132, 255, 0.9) -10%, rgba(99, 90, 249, 0) 70%),
              radial-gradient(ellipse at bottom left, rgba(76, 209, 255, 0.9) -10%, rgba(99, 90, 249, 0) 70%)
            `,
            filter: "blur(40px)",
          }}
          animate={{
        ...
        <motion.div
          ...
          style={{
            background: `
              radial-gradient(circle at bottom center, rgba(181, 78, 249, 0.9) -20%, rgba(99, 90, 249, 0) 60%)
            `,
            filter: "blur(45px)",
          }}
          animate={{
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(90deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.9) 50%, rgba(255, 255, 255, 0.1) 100%)",
          }}
          animate={{
            boxShadow: isHovered
              ? "0 0 25px 5px rgba(192, 132, 255, 1.0), 0 0 35px 7px rgba(158, 98, 205, 0.9), 0 0 45px 9px rgba(76, 209, 255, 0.7)"
              : "0 0 20px 4px rgba(192, 132, 255, 0.9), 0 0 30px 6px rgba(158, 98, 205, 0.8), 0 0 40px 8px rgba(76, 209, 255, 0.6)",
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(to top, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.7) 20%, rgba(255, 255, 255, 0.5) 40%, rgba(255, 255, 255, 0.2) 60%, rgba(255, 255, 255, 0) 80%)",
          }}
          animate={{
            boxShadow: isHovered
              ? "0 0 25px 5px rgba(192, 132, 255, 1.0), 0 0 35px 7px rgba(158, 98, 205, 0.9), 0 0 45px 9px rgba(76, 209, 255, 0.7)"
