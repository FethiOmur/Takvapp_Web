  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        ...
        >
          <div className="absolute left-0 top-0 h-[80rem] w-[35rem] -translate-y-[350px] -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,85%,0.08)_0,hsla(0,0%,55%,0.02)_50%,hsla(0,0%,45%,0)_80%)]" />
          <div className="absolute left-0 top-0 h-[80rem] w-56 -translate-y-[350px] -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,85%,0.06)_0,hsla(0,0%,45%,0.02)_80%,transparent_100%)]" />
          <div className="absolute left-0 top-0 h-[80rem] w-56 -rotate-45 bg-[radial-gradient(50%_50%_at_50%_50%,hsla(0,0%,85%,0.04)_0,hsla(0,0%,45%,0.02)_80%,transparent_100%)] [translate:5%_-50%]" />
        </div>
        <section>
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=3276&q=80"
                alt="background"
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  <Link
                    href="#link"
                    className="bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 hover:bg-background dark:hover:border-t-border dark:border-t-white/5 dark:shadow-zinc-950"
                  >
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                />
                <div className="inset-shadow-2xs ring-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border bg-background p-4 shadow-lg shadow-zinc-950/15 ring-1 dark:inset-shadow-white/20">
                  <img
                    className="relative hidden aspect-[15/8] rounded-2xl bg-background dark:block"
                    src="https://images.unsplash.com/photo-1545239351-1141bd82e8a6?auto=format&fit=crop&w=2700&q=80"
                    alt="app screen"
                    width={2700}
                    height={1440}
                  />
                  <img
                    className="z-2 relative aspect-[15/8] rounded-2xl border border-border/25 dark:hidden"
                    src="https://images.unsplash.com/photo-1557683316-973673baf926?auto=format&fit=crop&w=2700&q=80"
                    alt="app screen"
                    width={2700}
                    height={1440}
                  />
            ...
            <div className="mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 group-hover:blur-xs sm:gap-x-16 sm:gap-y-14">
              <div className="flex">
                <img
                  ...
                  src="https://images.unsplash.com/flagged/photo-1573164713988-8665fc963095?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={20}
                />
              </div>
              <div className="flex">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={16}
                />
              </div>
              <div className="flex">
                <img
                  className="mx-auto h-4 w-fit dark:invert"
                  src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={16}
                />
              </div>
              <div className="flex">
                <img
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://images.unsplash.com/photo-1523475472560-d2df97ec485c?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={20}
                />
              </div>
              <div className="flex">
                <img
                  className="mx-auto h-5 w-fit dark:invert"
                  src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={20}
                />
              </div>
              <div className="flex">
                <img
                  className="mx-auto h-4 w-fit dark:invert"
                  src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={16}
                />
              </div>
              <div className="flex">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={28}
                />
              </div>
              <div className="flex">
                <img
                  ...
                  src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=256&q=60"
                  alt="Brand logo"
                  height={24}
                />
              </div>
        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                <Menu className="group-data-[state=active]:scale-0 group-data-[state=active]:opacity-0 m-auto size-6 duration-200 in-data-[state=active]:rotate-180" />
                <X className="group-data-[state=active]:scale-100 group-data-[state=active]:opacity-100 absolute inset-0 m-auto size-6 -rotate-180 scale-0 opacity-0 duration-200" />
              </button>
            </div>
            ...
            <div className="group-data-[state=active]:block lg:group-data-[state=active]:flex dark:shadow-none dark:lg:bg-transparent mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border bg-background p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
