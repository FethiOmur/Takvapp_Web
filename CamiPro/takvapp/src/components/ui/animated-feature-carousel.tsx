...
export type FeatureCarouselImageSet = ImageSet;
...
const steps: readonly Step[] = [
  {
    ...
    description:
      "Connect your tools and workflows effortlessly. Our platform integrates with hundreds of popular apps.",
  },
  {
    id: "2",
    name: "Step 2",
    ...
    description:
      "Gain deep insights with our advanced analytics dashboard. Track your performance and make data-driven decisions.",
  },
  {
    id: "3",
    name: "Step 3",
    ...
    description:
      "Work together in real-time. Share, comment, and edit with your team from anywhere in the world.",
  },
  {
    id: "4",
    name: "Step 4",
    ...
    description:
      "Put your tasks on autopilot. Create custom automations to save time and reduce manual work.",
  },
];
  ...
  ({ src, alt, className, style, ...props }, ref) => {
    return (
      <img
        ...
        onError={(event) => {
          event.currentTarget.src = placeholderImage(alt);
        }}
        {...props}
      />
    );
  ...
  return (
    <nav aria-label="Progress" className="flex justify-center px-4">
      <ol
        ...
        role="list"
      >
        {stepItems.map((stepItem, stepIdx) => {
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="hidden sm:inline-block">{stepItem.name}</span>
              </button>
            </motion.li>
          );
        })}
...
export function FeatureCarousel({
  ...
  return (
    <div className="flex w-full max-w-4xl flex-col gap-12 p-4">
