      ...
      setBeats([
        {
          ...
          beatstarsUrl: "https://openai.com/gpt-4",
        },
        {
          id: "2",
          name: "Claude 3 Opus",
          ...
          audio: "/placeholder.mp3",
          image: "/placeholder.svg?height=200&width=200",
          beatstarsUrl: "https://www.anthropic.com/claude",
        },
        {
          id: "3",
          name: "Llama 3",
          ...
          audio: "/placeholder.mp3",
          image: "/placeholder.svg?height=200&width=200",
          beatstarsUrl: "https://ai.meta.com/llama/",
        },
      ])
      setLoading(false)
    }, 1500)
                  ...
                  <CardFooter>
                    <Button asChild className="w-full bg-purple-600 hover:bg-purple-700">
                      <a href={beat.beatstarsUrl} target="_blank" rel="noopener noreferrer">
                        View Model Details <ExternalLink className="ml-2 h-4 w-4" />
                      </a>
                    </Button>
                  </CardFooter>
                </Card>
